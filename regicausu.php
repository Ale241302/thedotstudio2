...
<body>
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      <form class="sign-in-htm" action="./api/user/capiusu.php?usuario1=<?php echo $usuario1; ?>&rol=<?php echo $rol; ?>" method="POST">
        <div class="group">
          <label for="user" class="label">Usuario</label>
           <select style="background-color: rgba(255, 255, 255, 0.7); color: #000;" id="usuario" name="usuario" type="text" class="input" required>
          <?php
             if ($rol == 1) {
        ...
        <div class="group">
          ...
          <select style="background-color: rgba(255, 255, 255, 0.7); color: #000;" id="capacitacion" name="capacitacion" type="text" class="input" required>
          <?php
        ...
        <div class="group">
           <label for="fecha-hora-inicio" class="label">Fecha y hora de Asistencia</label>
      ...
      <div class="group">
          <button id="volel" class="button" style="position: absolute;top: 90%;" onclick="location.href='capacitacionesusu.php?usuario1=<?php echo $usuario1; ?>&rol=<?php echo $rol; ?>'">Volver</button>
      </div>
      <div class="group">
          <button id="vole" class="button" style="position: absolute;top: 110%;" onclick="location.href='./api/user/cerrar.php?usuario1=<?php echo $usuario1; ?>&metodo=get;'">Cerrar sesión</button>
        </div>
    </div>
  </div>
</div>
